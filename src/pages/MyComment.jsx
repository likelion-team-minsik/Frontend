...
import * as R from "../styles/StyledMyComment";
              ...
              <R.PostBoxOfBox>
                <R.PostBox>
                  ...
                  <R.Inpro><img
                    ...
                    width="23.736px"
                  /></R.Inpro> 
                        <R.Box3><R.Name>클밍후삼겹</R.Name><R.Time>6시간 전</R.Time></R.Box3> 
                    </R.Box2>

                    <R.PostTitle>역시 클라이밍 후엔 삼겹살이지</R.PostTitle> 
                    <R.Content>OO암장 근처 삼겹살 집 공유합니다!!
                        <br/>진짜 맛도리@ 여기 꼭 가세요...</R.Content>
                </R.PostBox>
              </R.PostBoxOfBox>
            </R.BackBox>
        </R.Background>

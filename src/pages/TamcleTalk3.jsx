...
function TamcleTalk2() {
  ...
  const ClickBookIcon = (index) => {
    setBookIcons((prev) => prev.map((item, i) => (i === index ? !item : item)));
  };
  ...
  return (
    <R.Background>
      <R.BackBox>
        ...
        <R.Box5>
          <R.AddContent onClick={goLogin}>
            <img
              src={`${process.env.PUBLIC_URL}/images/AddContent.png`}
              width="53.393px"
            />
          </R.AddContent>
          <R.MyPage onClick={goLogin}>
            <img
              src={`${process.env.PUBLIC_URL}/images/Mypage.png`}
              width="53.393px"
            />
          </R.MyPage>
        </R.Box5>

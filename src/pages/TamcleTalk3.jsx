...
<R.PostBoxOfBox>
         ...
         <R.PostBox key={index} onClick={goLogin} >
              <R.Box1>
                <R.Profile>
                  <img
      ...
      <R.Box5><R.AddContent onClick={goLogin}><img src={`${process.env.PUBLIC_URL}/images/AddContent.png`} width="53.393px"/></R.AddContent> 
      <R.MyPage onClick={goLogin}><img src={`${process.env.PUBLIC_URL}/images/Mypage.png`} width="53.393px"/></R.MyPage></R.Box5>
      </R.BackBox>
    </R.Background>
  );
}

export default TamcleTalk2;
      ...
      <R.BackBox>
        ...
        <R.CommentBox>
          {filteredComments.map((comment, index) => (
            <R.Comment
              key={index}
              style={{ marginBottom: comment.image !== 0 ? "70px" : "-50px" }}
            >
              <R.Box1>
                <R.Profile>
                  <img
              ...
              {comment.image !== 0 && (
                <R.CommentImg>
                  <img
                    src={`${process.env.PUBLIC_URL}/images/${comment.image}`}
                    width="103"
                  />
                </R.CommentImg>
              )}
              <R.Box6>
                ...
                {comment.HeartNum != 0 && (
                  <R.GrayHeartNum>{comment.HeartNum}</R.GrayHeartNum>
                )}
        ...
        <R.CommentRec>
          <img
            src={`${process.env.PUBLIC_URL}/images/CommentRec.png`}
            width="393px"
          />
          <R.AddBox>
            <R.Camera>
            ...
            <R.CommentVar>
              <img
                src={`${process.env.PUBLIC_URL}/images/CommentVar.png`}
                width="295px"
              />
            </R.CommentVar>
          </R.AddBox>
